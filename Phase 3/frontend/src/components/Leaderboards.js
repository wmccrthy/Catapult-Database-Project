        ...
        <div id="cont" className="max-h-156 w-full overflow-scroll flex flex-col content-center items-center justify-evenly">
            ...
            <select className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" value={null} id="sel" onChange={async function (e) {
                ...
                if (active2 != null) {
                    ...
                    setDisplay2(<PlayerSessionGraph width={document.querySelector("#cont").offsetWidth} data={updatedData} dataKeys={[curMetric]}></PlayerSessionGraph>)
                }}}>
            ...
            <div className="w-full flex items-center content-center justify-center text-center gap-10 mb-5 mt-3"> 
                <button className="leaderButton text-[1vw] text-gray-700 uppercase  dark:text-gray-400" onClick={async function(e) {
                    ...
                    setDisplay2(<PlayerSessionGraph width={document.querySelector("#cont").offsetWidth} data={data} dataKeys={["distance"]}></PlayerSessionGraph>)
                ...
                <button className="leaderButton text-[1vw] text-gray-700 uppercase  dark:text-gray-400" onClick={async function(e) {
                    ...
                    setDisplay2(<PlayerSessionGraph width={document.querySelector("#cont").offsetWidth} data={data} dataKeys={["sprintdistance"]}></PlayerSessionGraph>)
                    toggleButton2(e.target)
                }}>Sprint Distance</button>
                 <button className="leaderButton text-[1vw] text-gray-700 uppercase  dark:text-gray-400" onClick={async function(e) {
                    var typeFilter = document.querySelector("#sel").value;
                    ...
                    setDisplay2(<PlayerSessionGraph width={document.querySelector("#cont").offsetWidth} data={data} dataKeys={["distancepermin"]}></PlayerSessionGraph>)
                    toggleButton2(e.target)
                ...
                <button className="leaderButton text-[1vw] text-gray-700 uppercase  dark:text-gray-400" onClick={async function(e) {
                    ...
                    setDisplay2(<PlayerSessionGraph width={document.querySelector("#cont").offsetWidth} data={data} dataKeys={["topspeed"]}></PlayerSessionGraph>)
                    toggleButton2(e.target)
                }}>Top Speed</button>
                 <button className="leaderButton text-[1vw] text-gray-700 uppercase  dark:text-gray-400" onClick={async function(e) {
                    var typeFilter = document.querySelector("#sel").value;
                    ...
                    setDisplay2(<PlayerSessionGraph width={document.querySelector("#cont").offsetWidth} data={data} dataKeys={["energy"]}></PlayerSessionGraph>)
                    toggleButton2(e.target)
                }}>Energy</button>
                 <button className="leaderButton text-[1vw] text-gray-700 uppercase  dark:text-gray-400" onClick={async function(e) {
                    var typeFilter = document.querySelector("#sel").value;
                    ...
                    setDisplay2(<PlayerSessionGraph width={document.querySelector("#cont").offsetWidth}  data={data} dataKeys={["playerload"]}></PlayerSessionGraph>)
                    toggleButton2(e.target)
                }}>Player Load</button>
            </div>
            {display2}
