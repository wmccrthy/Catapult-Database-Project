...
const Tabs = () => {
    ...
    return (
        <div className="flex w-full min-h-full h-full justify-evenly">
            {/* <div id="nav" className="mb-10 overflow-hidden flex align-center justify-between w-7/12 h-16 bg-gray-50 border border-t-0 border-gray-300 text-gray-900 text-sm font-bold rounded-b-lg bg-gray-900 border-gray-600 placeholder-gray-400 text-white relative">
            ...
            <div id="nav" className="fixed z-50 top-0 md:left-0 flex md:flex-col md:pl-0 align-center items-center justify-evenly w-full md:w-20 h-28  md:h-full  border-b md:border-r   text-sm font-bold bg-gray-900 border-gray-800 placeholder-gray-400 text-white">
                ...
                <button className="h-fit w-full flex items-center justify-center" onClick={(e) => {
                    ...
                    <div className="group flex items-center align-center overflow-visible">
                        <IoIosMan size="60" className="hover:rounded-md hover:bg-gray-600 rounded-3xl p-3 transition-all duration-500 bg-gray-800" onMouseOver={() => { handleMouseOver("Players")}}></IoIosMan>
                ...
                <button className="h-fit w-full flex items-center justify-center" onClick={(e) => {
                    ...
                    <div className="group flex items-center align-center overflow-visible">
                        <IoCalendarSharp size="60" className="hover:rounded-md hover:bg-gray-600 rounded-3xl p-3 transition-all duration-500 bg-gray-800 " onMouseOver={() => { handleMouseOver("Sessions")}}></IoCalendarSharp>
                ...
                <button className="w-full h-fit flex items-center justify-center"onClick={(e) => {
                    ...
                    <div className="group flex items-center align-center overflow-visible">
                        <FaTrophy size="60" className="hover:rounded-md hover:bg-gray-600 rounded-3xl p-3 transition-all duration-500 bg-gray-800" onMouseOver={() => { handleMouseOver("Leaderboards")}}></FaTrophy>
                ...
                <button className="h-fit w-full flex items-center justify-center" onClick={(e) => {
                    ...
                    <div className="group flex items-center align-center overflow-visible">
                        <FaPlus size="60" className="hover:rounded-md hover:bg-gray-600 rounded-3xl p-3 transition-all duration-500 bg-gray-800" onMouseOver={() => { handleMouseOver("Add Data")}}></FaPlus>
                        <span className="group-hover:scale-100 w-20 flex items-center justify-center h-7 absolute md:left-24 top-10 md:top-auto opacity-90 scale-0 transition duration-300  border text-xs font-light rounded-lg p-2.5 bg-gray-700 border-gray-600 placeholder-gray-400 text-white">{hovText}</span> </div>
                </button>
